...
type FileFieldsEnum =
  ...
  | 'childrenMdx.frontmatter.content'
...
type BookQueryVariables = Exact<{
  id: Scalars['String'];
}>;


type BookQuery = { readonly mdx: { readonly body: string, readonly tableOfContents: Record<string, unknown> | null, readonly frontmatter: { readonly title: string } | null } | null };

type IndexQueryVariables = Exact<{ [key: string]: never; }>;


type IndexQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly frontmatter: { readonly title: string, readonly date: string | null, readonly content: string | null, readonly slug: string | null, readonly description: string | null, readonly cover: { readonly publicURL: string | null } | null } | null }> } };

type PageSlugsQueryVariables = Exact<{ [key: string]: never; }>;


type PageSlugsQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly frontmatter: { readonly slug: string | null } | null }> } };
